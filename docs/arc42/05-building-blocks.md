...
graph LR
    subgraph TSC["TSCompiler"]
        ...
        CM["checkMany: tsgo --noEmit --pretty false --target esnext --lib esnext<br/>--strict false --module esnext --moduleDetection force --esModuleInterop<br/>--allowJs --checkJs <paths> wb-rules.d.ts /tmp/wb-controls-*.d.ts<br/>60 s ctx timeout, Pdeathsig, tsDiagRx"]
