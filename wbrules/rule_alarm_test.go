...
func (s *AlarmSuite) loadAlarmsSkipping(skipLine string) {
	...
	s.VerifyUnordered(
		...
		"driver -> /devices/sampleAlarms/controls/alarm_importantDeviceIsOff/meta: [{\"order\":1,\"readonly\":\"1\",\"type\":\"alarm\"}] (QoS 1, retained)",
		...
		"driver -> /devices/sampleAlarms/controls/alarm_temperatureOutOfBounds/meta: [{\"order\":2,\"readonly\":\"1\",\"type\":\"alarm\"}] (QoS 1, retained)",
		...
		"driver -> /devices/sampleAlarms/controls/alarm_unnecessaryDeviceIsOn/meta: [{\"order\":3,\"readonly\":\"1\",\"type\":\"alarm\"}] (QoS 1, retained)",
		...
		"driver -> /devices/sampleAlarms/controls/log/meta: [{\"order\":4,\"readonly\":\"1\",\"type\":\"text\"}] (QoS 1, retained)",
