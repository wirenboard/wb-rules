...
func (s *RuleNotifyWebhookSuite) TestGetNoBody() {
	...
	s.VerifyUnordered(
		...
		"wbrules-log -> /wbrules/log/info: [sending webhook: GET https://example.com] (QoS 1)",
		"wbrules-log -> /wbrules/log/info: [run command: curl -sS --fail -X 'GET' -H 'Content-Type: text/plain; charset=utf-8' -- 'https://example.com/ping'] (QoS 1)",
	)
}
...
func (s *RuleNotifyWebhookSuite) TestCustomHeaders() {
	...
	s.VerifyUnordered(
		...
		"wbrules-log -> /wbrules/log/info: [sending webhook: POST https://example.com] (QoS 1)",
		"wbrules-log -> /wbrules/log/info: [run command: curl -sS --fail -X 'POST' -H 'Content-Type: application/json' -H 'Authorization: Bearer xyz' --data-binary @- -- 'https://example.com/hook'] (QoS 1)",
...
func (s *RuleNotifyWebhookSuite) TestCustomContentType() {
	...
	s.VerifyUnordered(
		...
		"wbrules-log -> /wbrules/log/info: [sending webhook: POST https://example.com] (QoS 1)",
		"wbrules-log -> /wbrules/log/info: [run command: curl -sS --fail -X 'POST' -H 'Content-Type: text/csv; charset=utf-8' --data-binary @- -- 'https://example.com/hook'] (QoS 1)",
