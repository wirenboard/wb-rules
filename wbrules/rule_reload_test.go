...
func (s *RuleReloadSuite) SetupTest() {
	...
	s.Verify(
		"[info] detRun",
		"[info] detectRun: s=false, a=10",
		"[info] detectRun1: s=false, a=10",
	)
}
...
func (s *RuleReloadSuite) VerifyRules() {
	...
	s.VerifyUnordered(
		...
		"[info] detRun",
		"[info] detectRun: s=true, a=10",
		"[info] detectRun1: s=true, a=10",
	...
	s.VerifyUnordered(
		...
		"[info] detRun",
		"[info] detectRun: s=true, a=17",
		"[info] detectRun1: s=true, a=17",
