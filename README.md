...
Параметр name - произвольное имя правила (не обязательный); Тип правила - указывается один из существующих типов правил (читайте ниже), определяет условия для срабатывания правила; then - определяет функцию которая, выполняется при срабатывании правила.
Например:
```js
