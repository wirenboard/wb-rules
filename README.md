...
- [Совместимость с версией 2.2](#Совместимость-с-версией-2.2)
...
## Совместимость с версией 2.2

При обновлении с версии 1.7 предполагается, что большинство скриптов продолжат работу без каких-либо изменений.
Однако, стали более строго проверяться типы устанавливаемых значений для контролов:
