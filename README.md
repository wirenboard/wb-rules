...
Конфигурирование поведения может производиться при помощи переменных окружения. Возможные параметры и их значения приведены в таблице ниже:

| Переменная | Допустимые значения | Значение по умолчанию | Описание |
| ---------- | ------------------- | --------------------- | -------- |
| WBGO_STORAGE_CACHE_SEC | >= 1 | 30 | Количество секунд между сохранением значений контролов на диск |
