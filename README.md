...
- [Встроенные функции и переменные](#Встроенные-функции-и-переменные)
  ...
  - [Алиасы defineAlias()](#Алиасы `defineAlias()`)
  - [Форматирование строки format()](#Форматирование строки `format()`)
  - [Форматирование строки xformat()](#Форматирование строки `xformat()`)
  - [Вывод сообщений в лог log.](#Вывод сообщений в лог `log.`)
  - [Подписка на MQTT-топики trackMqtt()](#Подписка на MQTT-топики `trackMqtt()`)
  - [Публикация сообщений в MQTT publish()](#Публикация сообщений в MQTT `publish()`)
  - [Запуск внешних процессов spawn()](#Запуск внешних процессов spawn())
- [Модули](#Модули)
