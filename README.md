...
Rule engine for Wiren Board, version 3.0

Движок правил для контроллеров Wiren Board, версия 3.0
...
Начиная с версии wb-rules 2.0 появилась возможность управлять выполнением правил. Функция `defineRule()` возвращает идентификатор созданного правила (аналогично `setTimeout()`/`setInterval()`), который можно использовать позже для выключения/включения отработки правила или принудительного запуска тела правила.
